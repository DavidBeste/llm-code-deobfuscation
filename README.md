...
1. ```python3 create_training_data_chain.py --tokenizer deepseek-ai/deepseek-coder-6.7b-instruct --max_tokens 2048 --chain_length 1 --number_of_samples 3000```
...
4.```python3 create_eval_data_chain.py --tokenizer deepseek-ai/deepseek-coder-6.7b-instruct --max_tokens 2048 --chain_length 1 --number_of_samples 1000```
