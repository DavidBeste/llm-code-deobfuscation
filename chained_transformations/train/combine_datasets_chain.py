...
for c in range(1,6):
    with open("datasets/obfuscation_dataset_" + str(c) + "_chain_6144_training.txt", "r") as f:
        dataset = f.read()
...
with open("datasets/obfuscation_dataset_chain_6144_all_training.txt", "w") as f:
